...
//-----------------------------------------------------------------------------
// DESCRIPTION:
// Takes a string and outputs it to the Serial Console using the UART0 module.
//
// INPUT PARAMETERS:
...
//-----------------------------------------------------------------------------
// DESCRIPTION:
// Takes a string and outputs it to the Serial Console, ending with a newline.
//
// INPUT PARAMETERS:
//  string - the string to output.
//
...
//  value:  The integer value to be formatted and incuded in the formatted
//          string.
//
// OUTPUT PARAMETERS:
//  none
...
void msp_printf(char* buffer, unsigned int value)
{
    ...
    // Walk through array to send each character ro serial port
    for (i = 0; i < len; i++) 
    {
